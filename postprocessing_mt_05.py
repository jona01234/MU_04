...
__original_author__ = "Ondřej Dušek" https://github.com/ufal/mtmonkey
__modifier__ = "YeonJoo Oh, Chanel Caratti"

This python script by Ondřej Dušek has been modified in order to adapt to MT PostProcessing exercise
"""
...
class Detokenizer(object):
    ...
    # Contraction fo english language
